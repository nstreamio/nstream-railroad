...
(function(global, factory) {
  ...
  __decorate([ controller.TraitViewRef({
    ...
    initView(widgetView) {
      ...
      widgetView.marginTop.setState(4, component.Affinity.Intrinsic);
  ...
  class MagnifierHandle extends button.ButtonMembrane {
    ...
    initHandle() {
      ...
      this.marginBottom.setState(4, component.Affinity.Intrinsic);
  ...
  __decorate([ view.ViewRef({
    ...
    createView() {
      ...
      fixturesView.flexGrow.setState(1, component.Affinity.Intrinsic);
